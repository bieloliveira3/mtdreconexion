...
export const METHOD_PRICE_COP = "23.235 COP";
export const METHOD_DISCOUNT = "-53%";
export const TOOLBOX_PRICE = "US$ 4,99";
export const FULL_BUNDLE_PRICE = "US$ 11,98";
export const FULL_BUNDLE_PRICE_COP = "39.822 COP";
...
export const SUPPORT_EMAIL = BUSINESS_EMAIL;

export const PRIVACY_URL = "/privacidad";
export const TERMS_URL = "/terminos";
export const REFUND_URL = "/reembolsos";
