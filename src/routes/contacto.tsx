  ...
  return (
    <LegalLayout title="Contacto" showNote={false}>
      ...
      <div className="grid gap-4 rounded-2xl border border-border bg-surface p-6">
        ...
        <a
          href="https://wa.me/message/5OOUAWJN2Y6OI1"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center justify-center gap-2 justify-self-start rounded-xl bg-[#25D366] px-6 py-3 text-[0.9rem] font-semibold text-white shadow-soft transition-all duration-300 hover:bg-[#128C7E] hover:shadow-lift focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring"
        >
          <svg
